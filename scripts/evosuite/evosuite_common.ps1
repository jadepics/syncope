...
$script:TargetClass = "org.apache.syncope.core.spring.security.jws.AccessTokenJWSVerifier"
$script:TargetClassRelative = "org\apache\syncope\core\spring\security\jws\AccessTokenJWSVerifier"
...
$script:GeneratedPackageDir = Join-Path $script:GeneratedTestRoot "org\apache\syncope\core\spring\security\jws"
$script:GeneratedTestFile = Join-Path $script:GeneratedPackageDir "AccessTokenJWSVerifier_ESTest.java"
$script:GeneratedScaffoldingFile = Join-Path $script:GeneratedPackageDir "AccessTokenJWSVerifier_ESTest_scaffolding.java"
$script:GeneratedTestFqn = "org.apache.syncope.core.spring.security.jws.AccessTokenJWSVerifier_ESTest"

$script:CompatRoot = Join-Path $script:RepoRoot "target\evosuite-compat\jws"
$script:CompatClasses = Join-Path $script:CompatRoot "classes"
$script:CompatSource = Join-Path $script:CompatRoot "src\AccessTokenJWSVerifier.java"
...
$script:EvoGeneratedRoot = Join-Path $script:ModuleDir "target\evosuite-generated\jws"
...
$script:TemporaryRunPom = Join-Path $script:ModuleDir "pom-evosuite-jws-temp.xml"
...
function New-TemporaryEvoSuiteRunPom {
    ...
    [void]$profile.AppendChild((New-Element "id" "evosuite-jws-temp"))
